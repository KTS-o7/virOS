...
struct tss tss;
struct gdt gdt_real[viros_TOTAL_GDT_SEGMENTS];
struct gdt_structured gdt_structured[viros_TOTAL_GDT_SEGMENTS] = {
...
void kernel_main()
{
    ...
    gdt_structured_to_gdt(gdt_real, gdt_structured, viros_TOTAL_GDT_SEGMENTS);
